 ...
 */
class German_LocalePackZa_Block_System_Config_Form_Fieldset_Instructions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
    	$nodepath = "modules/German_LocalePackZa";
        $helper = Mage::helper("localepackza");
	...
	if (!array_key_exists("German_LocaleFallback", $modules)) {
		...
		$html .= $helper->__("On the <a href='%s'>Magento Connect page of the South African English language pack</a>, you can find more information on the latest versions.",
