 ...
 */
class German_LocalePackZa_Model_Observer {
    ...
    public function getVersionNumber() {
        ...
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackZa/version');
    }
    ...
    public function getManageUrl() {
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackza'));
    }
}
